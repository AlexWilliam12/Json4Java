...
public final class JsonArray implements List<JsonNode>, JsonNode {
    ...
    /**
     * Returns the underlying list of {@link JsonNode} values in this JSON
     * array.
     *
     ...
     *
     * @return {@code true} if this array contains no elements, {@code false}
     * otherwise
     */
    @Override
    ...
    /**
     * Returns an array containing all the elements in this JSON array in proper
     * sequence.
     *
     ...
     * array.
     *
     * @param a the array into which the elements of this JSON array are to be
     * stored
    ...
    /**
     * Removes the first occurrence of the specified element from this JSON
    ...
    /**
     * Checks whether this JSON array contains all the elements in the specified
     * collection.
     *
     * @param collection the collection to be checked for containment in this
     * array
     * @return {@code true} if this array contains all the elements in the
    ...
    /**
     * Inserts all the elements in the specified collection into this JSON array
    ...
    /**
     * Removes from this JSON array all of its elements that are contained in
    ...
    /**
     * Retains only the elements in this JSON array that are contained in the
     * specified collection.
     *
    ...
    /**
     * Replaces the element at the specified position in this JSON array with
    ...
    /**
     * Inserts the specified element at the specified position in this JSON
     * array.
     *
     ...
     * this JSON array, or -1 if this array does not contain the element.
     *
     * @param value the element to search for
     * @return the index of the first occurrence of the specified element, or -1
     * if this array does not contain the element
     */
    @Override
     ...
     * JSON array, or -1 if this array does not contain the element.
     *
     * @param value the element to search for
    ...
    /**
     * Returns a list iterator over the elements in this JSON array (in proper
     * sequence).
     *
    ...
    /**
     * Returns a view of the portion of this JSON array between the specified
